...
UK_state_RN_data <- read.spss("C:/Users/cwbishop/Documents/dropbox/Dropbox/Kelly and Michael/UK England Online.sav", to.data.frame=TRUE,use.value.labels=FALSE)
